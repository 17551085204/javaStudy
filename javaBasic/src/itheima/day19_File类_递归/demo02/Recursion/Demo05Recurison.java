package itheima.day19_File类_递归.demo02.Recursion;
...
public class Demo05Recurison {
    public static void main(String[] args) {
        File file = new File("E:\\Java_IntelliJ_IDEA_WorkSpace\\MyProjects\\project00\\src\\javaStudy\\java基础入门\\黑马程序员课程\\day19_File类_递归");
        getAllFile(file);
    }
